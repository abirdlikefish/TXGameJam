...
public class UIMate : Singleton<UIMate>, IInit
{
    ...
    public void OnDrag()
    {
        btDrag.gameObject.SetActive(false);
        magnetX.gameObject.SetActive(true);
        magnetZ.gameObject.SetActive(true);
    }
    public void OnMove()
    {
        magnetX.gameObject.SetActive(false);
        magnetZ.gameObject.SetActive(false);
    }
