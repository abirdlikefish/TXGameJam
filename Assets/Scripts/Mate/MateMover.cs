...
public class MateMover : MonoBehaviour
{
    ...
    Vector3 nextCenter;
    Vector3 moveDir;
    bool CanTooru => (DeliConfig.tooruTest  ? MateInput.CanTooruY0(CurCenter,nextCenter) : MateInput.CanTooruY0(nextCenter) )&& !DouguManager.Instance.HasBlock(nextCenter);
